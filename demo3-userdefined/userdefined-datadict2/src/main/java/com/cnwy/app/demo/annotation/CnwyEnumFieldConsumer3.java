...
public @interface CnwyEnumFieldConsumer3 {
     ...
     * @return 枚举
     */
    String value() default StringConstants.SYS_DICT_3;
    ...
    class BaseEnumGroupEnumParser implements EnumDBFieldConsumer.ValueParser {
        ...
        public String[] apply(CField cField) {
            CnwyEnumFieldConsumer3 annotation = (CnwyEnumFieldConsumer3) cField.getAnnotation();
            return Stream.of(annotation.enumGroup()).map(SysDictType3Enum::getGroup).toArray(String[]::new);
        }
    }
}
