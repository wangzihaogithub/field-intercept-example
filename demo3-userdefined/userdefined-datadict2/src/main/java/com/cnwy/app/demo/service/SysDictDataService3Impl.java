...
@Service
public class SysDictDataService3Impl extends AbstractCrudService<SysDictDataMapper, SysDictData, Long> {

    @Component(StringConstants.SYS_DICT_3)
    public static class BaseEnumKeyNameFieldConsumer extends EnumDBFieldIntercept<Object> {
        ...
        public Map<String, Map<String, Object>> selectEnumGroupKeyValueMap(Set<String> groups, Collection<Object> keys) {
            System.out.println("SysDictDataService3Impl#selectEnumGroupKeyValueMap");
